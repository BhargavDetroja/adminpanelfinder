...
################################################################# 
#Developed By Detroja Bhargav
use HTTP::Request;
use LWP::UserAgent;

system('cls');
system('Admin Control Panel Finder v1.0.0');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t> [!]Admin Control Panel Finder v1.0                 	>\n";
print "\t> [!]Developed By Detroja Bhargav                 	>\n";
print "\t> ======================================       		>\n";
print "\t> [!]Please Visite ==> https://www.code404.in		>\n";
print "\t> [!]Contact Us ==> bdetroja55@gmail.com           		>\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
